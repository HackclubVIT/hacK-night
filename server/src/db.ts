...
const participant_prepared_insert = db.prepare(
    "INSERT INTO participants(participant_name, participant_regno, participant_phone, participant_email, is_day_scholar, hostel_block, is_vegetarian, team_id) VALUES(@participant_name, @participant_regno, @participant_phone, @participant_email, @is_day_scholar, @hostel_block, @is_vegetarian, @team_id)"
);
